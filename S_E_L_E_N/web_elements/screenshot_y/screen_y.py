...
class Screenshots():
    ...
    def test(self):
        ...
        # destinationFile = '/S_E_L_E_N/web_elements/screenshot_y/' # dla Mac-a
        destinationFile = 'H:\\Git_projekty\\Udemy_selen_python\\S_E_L_E_N\\web_elements\\screenshot_y\\test.png' # dla windows
